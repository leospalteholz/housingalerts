    ...
    <div class="max-w-md mx-auto py-8">
        <form method="POST" action="{{ route('hearings.update', $hearing) }}" class="bg-white rounded shadow p-6">
            ...
            <div class="mb-4">
                ...
                <textarea id="body" name="body" required class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('body', $hearing->body) }}</textarea>
            </div>
            <div class="mb-4">
