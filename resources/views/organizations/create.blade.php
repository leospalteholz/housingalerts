<x-app-layout>
    ...
    <div class="max-w-md mx-auto py-8">
        <form method="POST" action="{{ route('organizations.store') }}" class="bg-white rounded shadow p-6">
            @csrf
            <div class="mb-4">
            ...
            <div class="mb-4">
                ...
                <input type="url" id="website_url" name="website_url" placeholder="https://example.com" class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500">
            </div>
            <div class="mb-4">
                <label for="about" class="block text-gray-700 font-semibold mb-2">About</label>
                <textarea id="about" name="about" rows="4" placeholder="Tell us about your organization..." class="w-full border border-gray-300 rounded px-3 py-2 focus:outline-none focus:ring-2 focus:ring-blue-500"></textarea>
            </div>
